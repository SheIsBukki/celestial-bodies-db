...
\restrict rL3R789qLyySfmEtmixvRC2317UrCLr5q2H474pWybNznmF4Yb1m1fseoPc53qn
...
\unrestrict rL3R789qLyySfmEtmixvRC2317UrCLr5q2H474pWybNznmF4Yb1m1fseoPc53qn
\connect universe
\restrict rL3R789qLyySfmEtmixvRC2317UrCLr5q2H474pWybNznmF4Yb1m1fseoPc53qn
...
--
-- Name: exploration_institution; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.exploration_institution OWNER TO postgres;

--
-- Name: exploration_institution_exploration_institution_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.exploration_institution_exploration_institution_id_seq OWNER TO postgres;

--
-- Name: exploration_institution_exploration_institution_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: exploration_institution exploration_institution_id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: exploration_institution; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
INSERT INTO public.exploration_institution VALUES (9, 'ESA', 'Hera / Earth & planetary science missions e.g. Juice mission operational phases', 'ESRO/ELDO predecessors — first ESA 
satellite: ESRO-1 (1968)', 'Rosetta');
...
INSERT INTO public.exploration_institution VALUES (12, 'CNES', 'Partic
ipation in JUICE / space science collaborations', 'A-1 rocket test / Véronique launches (early French space activities) — treat as first: Véronique rocket launches (1950s)', 'Arianae program');
INSERT INTO public.exploration_institution VALUES (13, 'Sloan Digital Sky Survey (SDSS)', 'SDSS-V operati
ons', 'SDSS first light / commissioning (2000)', 'SDSS Survey');
...
INSERT INTO public.galaxy VALUES (7, 'Messier 87', 'Elliptical', false, true, '53.5 mil
lion light years', 9.6);
...
INSERT INTO public.galaxy VALUES (11, 'Spindle', 'Lenticular', false, false, '44 million 
light years', 10.7);
...
INSERT INTO public.moon VALUES (4, 'Io', 5, '1.796 m/s squared', 1.769, 1.769, 'active (intense sulfur/mafic volcanism)', '~90–130 K (hot spots up to >1200 K at volcanoes)', 1821.600, '1610');
...
INSERT INTO public.moon VALUES (21, 'Triton', 8, '0.779 m/s squared', 5.877, 5.877, 'active (cryovol
canism, plumes, seasonal resurfacing)', '~30–38 K (surface ~38 K)', 1353.400, '1846');
...
INSERT INTO public.moon VALUES (25, 'Pho
ebe', 6, '0.036 m/s squared', 1092.000, 0.387, 'geologically inactive (primitive, heavily cratered; possible past activity at formation)', '~50–100 K (approx.)', 106.500, '1899');
...
INSERT INTO public.star VALUES (15, 'HV 11423', 9, 'M (red superg
iant)', 12.3, 'red', 'single');
...
--
-- Name: exploration_institution_exploration_institution_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: exploration_institution exploration_institution_exploration_institution_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: exploration_institution exploration_institution_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
